            ...
            <div className="card col-md-8 mb-5" style={{
                ...
                <div className="card-footer">
                    <div className="d-flex post-actions">
                        {like ? (
                            <h3>
                                <svg onClick={this.likeToggle} width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-suit-heart" style={{ cursor: "pointer", marginRight: "10px", marginTop: "13px" }} fill="#ff3a39" fil xmlns="http://www.w3.org/2000/svg">
